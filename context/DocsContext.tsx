...
export const DocsProvider: React.FC<DocsProviderProps> = ({ children }) => {
    ...
    [
      [
        ...
        },
        {
          ...
          path: "/research/#📌-Align-Your-Steps",
        },
        {
          title: "### 📌 HiDiffusion",
          description:
  ...
  const fetchDocs = async () => {
    try {
      const res = await fetch(`/api/searchDocs?query="Test"`, {
        method: "POST",
